...
load("pangenome_tpms.rdata") ## !!!!! THIS DATA IS ON THE PETA LIBRARY (/pl/active/Morris_CSU/data_sharing/pansorg_transcriptomes) AND THE ABOVE GOOGLE DRIVE LOCATION 
                             ## !!!!! A SMALLER DATASET FOR BTx623 IS AVAILABLE ON https://github.com/cvanges/GFA/btx623_tpms_small.rdata, see below

#Check which references have transcriptomes available
sort(names(tpms))
...
load("btx623_tpms_small.rdata") ## !!!!! THIS SMALL DATASET FOR BTx623 IS AVAILABLE ON https://github.com/cvanges/GFA/btx623_tpms_small.rdata
